...
class StationAQIDataRepository implements StationAQIDataRepositoryInterface
{
    private string $entity_name;
    public function __construct(
        private readonly EntityManager $entity_manager
    ) {
        $this->entity_name = StationAQIData::class;
    }

    public function save(StationAQIData $station_aqi_data): void
    {
        $this->entity_manager->persist($station_aqi_data);
    ...
    public function find($id, int $lock_mode = null, int $lock_version = null): ?StationAQIData
    {
    ...
    public function findOneByName(string $name): ?StationAQIData
    {
